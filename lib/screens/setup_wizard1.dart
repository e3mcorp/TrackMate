...
class _SetupWizardScreenState extends State<SetupWizardScreen>
  ...
  int _currentStep = 0;
  int get _totalSteps => widget.mode == SetupMode.firstDevice ? 5 : 3;
  ...
  // ✅ METODO _FINISH COMPLETAMENTE CORRETTO
  Future<void> _finish() async {
    setState(() => _sending = true);

    try {
      // ✅ CREA TRACKER con tutti i campi necessari
      final tracker = Tracker()
        ...
        ..adminNumber = _setupData.adminPhoneController.text.trim() // ✅ FIX: aggiungi admin
      ...
      // ✅ NAVIGAZIONE CORRETTA - USA CALLBACK O NAMED ROUTE
      if (widget.onComplete != null) {
        widget.onComplete!(); // ✅ Usa callback se disponibile
      } else {
      ...
      // ✅ MOSTRA ERRORE ma procedi comunque alla home
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
